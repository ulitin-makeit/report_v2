...
/**
 * DataProvider для поля "Дата оказания услуги"
 */
class ServiceDateDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_DATE_SERVICE_PROVISION';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Дата оказания услуги';
