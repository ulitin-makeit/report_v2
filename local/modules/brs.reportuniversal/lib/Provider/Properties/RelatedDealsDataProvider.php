...
/**
 * DataProvider для поля "Связанные сделки"
 */
class RelatedDealsDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_COMPLEMENTARY_SERVICES';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Связанные сделки';
