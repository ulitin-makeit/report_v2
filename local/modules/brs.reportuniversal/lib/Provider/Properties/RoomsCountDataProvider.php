...
/**
 * DataProvider для поля "Количество номеров"
 */
class RoomsCountDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_NUMBER_OF_ROOMS';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Количество номеров';
