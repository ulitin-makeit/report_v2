...
/**
 * DataProvider для поля "Дата окончания"
 */
class EndDateDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_FINISH_DATE';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Дата окончания';
