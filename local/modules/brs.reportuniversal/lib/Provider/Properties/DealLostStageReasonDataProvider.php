...
/**
 * DataProvider для поля "Причина стадии Сделка проиграна"
 */
class DealLostStageReasonDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_STAGE_OTHER_REASON';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Причина стадии Сделка проиграна';
