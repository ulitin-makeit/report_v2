...
/**
 * DataProvider для поля "Кросс-продажа"
 */
class CrossSaleDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_IS_CROSS_SELLING';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Кросс-продажа';
