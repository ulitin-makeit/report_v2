...
/**
 * DataProvider для поля "Дата начала"
 */
class StartDateDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_START_DATE';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Дата начала';
