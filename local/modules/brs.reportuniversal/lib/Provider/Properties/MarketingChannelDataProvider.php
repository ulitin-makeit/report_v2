...
/**
 * DataProvider для поля "Маркетинговый канал"
 */
class MarketingChannelDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_MARKETING_CHANNEL';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Маркетинговый канал';
