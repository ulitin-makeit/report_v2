...
/**
 * DataProvider для поля "Тип оплаты"
 */
class PaymentTypeDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_BRS_CRM_DEAL_PAYMENT_TYPE';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Тип оплаты';
