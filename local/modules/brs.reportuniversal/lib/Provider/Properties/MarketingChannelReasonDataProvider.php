...
/**
 * DataProvider для поля "Маркетинговый канал причина"
 */
class MarketingChannelReasonDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_MARKETING_CHANNEL_OTHER';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Маркетинговый канал причина';
