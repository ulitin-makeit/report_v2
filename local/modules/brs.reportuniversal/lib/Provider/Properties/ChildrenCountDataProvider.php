...
/**
 * DataProvider для поля "Количество детей"
 */
class ChildrenCountDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_NUMBER_OF_CHILDREN';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Количество детей';
