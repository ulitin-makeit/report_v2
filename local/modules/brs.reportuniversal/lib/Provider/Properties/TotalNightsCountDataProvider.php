...
/**
 * DataProvider для поля "Общее кол-во ночей"
 */
class TotalNightsCountDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_FULL_NUMBER_OF_NIGHTS';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Общее кол-во ночей';
