...
/**
 * DataProvider для поля "Кросс-продажа причина"
 */
class CrossSaleReasonDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CROSS_SELLING_REASON';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Кросс-продажа причина';
