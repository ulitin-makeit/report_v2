...
/**
 * DataProvider для поля "Количество взрослых"
 */
class AdultsCountDataProvider implements DataProviderInterface
{
	...
	private const FIELD_CODE = 'UF_CRM_DEAL_NUMBER_OF_ADULTS';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'Количество взрослых';
